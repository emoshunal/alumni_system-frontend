...
import SelectEmployment from '../pages/_admin/manage/user/form-select/SelectEmployment';



type propTypes = {
    onSubmitClickHnd: (data: IUserRegisters) => void;
}
const CreateAccountComponent: React.FC<propTypes> = ({ onSubmitClickHnd }) => {
    ...
    const [formData, setFormData] = useState<IUserRegisters>(initialState);
                ...
                <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            <span className="mb-1.5 block font-medium">Alumni Tracking System</span>
                            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                Please create an account
                            </h2>
                            {submitted ? (
                                <div>
                                    <h4>You have created an account! Wait for the admin to verify your info.</h4>
                                    <button className="block w-full rounded-full border border-stroke  bg-zinc-800 p-3 text-center font-medium text-white transition hover:bg-opacity-90 active:bg-opacity-80" onClick={newRegister}>
                                        Sign in
                                    </button>
                                </div>
                            ) : (
