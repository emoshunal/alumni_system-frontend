...
interface SelectEmploymentProps {
  selectedEmployment: string;
  onEmploymentChange: (employment: string) => void
}
const SelectEmployment: React.FC<SelectEmploymentProps> = ({ selectedEmployment, onEmploymentChange }) => {
    ...
    <div>
      ...
      <div className="relative z-20 bg-white dark:bg-form-input">
        ...
        <select
          ...
          onChange={(e) => {
            onEmploymentChange(e.target.value);
            changeTextColor();
          }}
          // onChange={(e) => {
